...
The iOS SDK is available to be integrated using SPM. It’s backward compatible down to iOS 13.0. To install it, simply add the url of this repo in your Xcode project through File > Add Package Dependencies... .
